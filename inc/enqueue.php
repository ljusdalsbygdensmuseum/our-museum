...
function OMUS_enqueue($hook)
{
    ...
    if ($hook != 'post.php' && $hook != 'post-new.php') {
        ...
        //Enqueue scripts
        wp_enqueue_script('omus-frontend-script', get_theme_file_uri('/build/frontend.js'), $assets['dependencies'], $assets['version'], true);

        //Enqueue styles
        wp_enqueue_style('omus-frontend-style', get_theme_file_uri('/build/frontend.css'));
